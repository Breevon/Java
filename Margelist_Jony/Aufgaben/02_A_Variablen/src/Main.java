public class Main {
    public static void main(String[] args) {
        ...
        int number1; // valid
        int speed; // valid
        int JustANUmber; //Not Valid, starts with a special character.
        int justAnotherNumber; //Not Valid, starts with a special character.
        ...
        int circumstanceEarth_KM;//Not Valid, unterschriech
